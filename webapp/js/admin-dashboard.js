...
window.mobileDeleteLead = mobileDeleteLead;
window.mobileCallLead = mobileCallLead;
window.mobileEmailLead = mobileEmailLead;
window.mobileWhatsAppLead = mobileWhatsAppLead;
window.toggleMobileAssignDropdown = toggleMobileAssignDropdown;
window.mobileSelectAssign = mobileSelectAssign;
window.toggleMobileStatusDropdown = toggleMobileStatusDropdown;
window.mobileSelectStatus = mobileSelectStatus;
